...
<div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Бронирование</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="#">Главное</a></li>
                            <li class="breadcrumb-item"><a href="#">Странцы</a></li>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        <h5 class="section-title ff-secondary text-start text-primary fw-normal">Бронирование</h5>
                        <h1 class="text-white mb-4">Забронировать Столик Онлайн</h1>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating date" id="date3" data-target-input="nearest">
                                        ...
                                        <label for="datetime">День и Время</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select class="form-select" id="select1">
                                          <option value="1">люди 1</option>
                                          <option value="2">люди 2</option>
                                          <option value="3">люди 3</option>
                                          <option value="3">люди 4</option>
                                          <option value="3">люди 5</option>

                                        </select>
                                        <label for="select1">Нет Людей </label>
                                      </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Special Request" id="message" style="height: 100px"></textarea>
                                        <label for="message">Специальный Запрос</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                <button class="btn4">
