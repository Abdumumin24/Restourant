...
<div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Delivery</h1>
...
<br>
<div class="group">
  <input  type="text" class="input" name="food_name">
...
<br>
<div class="group">
  <input  type="text" class="input" name="drink_name">
  <span class="highlight"></span>
  <span class="bar"></span>
...
<br>
<div class="group">
  <input  type="text" class="input" name="desert_name">
  <span class="highlight"></span>
  <span class="bar"></span>
  <label>Desert Name</label>
  
</div>
<br>
<div class="group">
  <input type="text" class="input2" name="number_food">
  <span class="highlight"></span>
  <span class="bar"></span>
...
<div class="group">
  <input  type="text" class="input3" name="number_drink">
  <span class="highlight"></span>
  <span class="bar"></span>
  <label class="label3">Number of Drink</label>
  
</div>
<br>
<div class="group">
  <input type="text" class="input4" name="number_desert">
  <span class="highlight"></span>
  <span class="bar"></span>
  <label>Number of Desert</label>
  
</div>
<div class="group">
  <input  type="text" class="input5" name="adress">
  <span class="highlight"></span>
  <span class="bar"></span>
  <label class="label5">Adress</label>
  
</div>
<br>
<div class="group">
  <input  type="text" class="input" value="+998" name="phone">
  <span class="highlight"></span>
  <span class="bar"></span>
...
<br>
  ...
  <br>
    <button class="submit" name="ready">Ready</button>
    <br>
    <br>
    <br>
    <br>
